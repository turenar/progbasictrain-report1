...
xfail _call -i"${pbmdir}/04_lf.pbm" -o"${outdir}/30_noise5.pbm" noise:
xfail _call -i"${pbmdir}/04_lf.pbm" -o"${outdir}/30_noise5.pbm" noise:2
xfail _call -i"${pbmdir}/04_lf.pbm" -o"${outdir}/30_noise5.pbm" noise:-3
